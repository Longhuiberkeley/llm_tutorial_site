...
9. **Prefer "LLM" over "AI".** In tutorial content, use "LLM" or "the LLM" when referring to the model specifically. "AI" is acceptable for the broader field or in human vs. AI comparisons — but avoid using "AI" as a generic synonym for "the model" in explanations.