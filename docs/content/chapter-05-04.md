...
- **Chain-of-Thought (CoT):** Manually prompting for step-by-step reasoning.
...
:::callout-dyk
Even when the reasoning chain contains errors, the simple act of spending more tokens on reasoning improves final accuracy. It's like how scribbling on scratch paper helps you solve a math problem, even if your scribbles aren't perfectly organized.
:::
