...
<!-- The Resume -->
<div class="bg-white border-2 border-outline-variant rounded-xl p-8 max-w-md mx-auto shadow-inner" id="jb-resume">
<div class="border-b-2 border-outline-variant pb-4 mb-6">
<h4 class="text-2xl font-bold">Alex Rivera</h4>
<p class="text-sm text-on-surface-variant">Senior Software Engineer</p>
</div>
<div class="space-y-4 text-[10px] text-on-surface-variant leading-relaxed">
...
-->
<div id="quiz-04-07" class="quiz-container bg-[#F9F9F9] border border-outline-variant rounded-xl p-6 mt-10">
