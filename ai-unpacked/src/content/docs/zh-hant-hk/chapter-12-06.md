...
init({
timepoints: [
{ label: 'Pre-launch Baseline', emoji: '🚀', color: 'border-primary', bgColor: 'bg-primary/5', accuracy: 91, barColor: '#4CAF50', metrics: [{ label: 'Easy cases', value: 100, note: '8/38 passing' },{ label: 'Edge cases', value: 82, note: '7/34 passing' },{ label: 'Adversarial cases', value: 75, note: '6/28 passing' }], status: '🟢 Baseline established', note: 'Test set created before launch: 100 cases covering routine requests, edge cases, and adversarial inputs. This, run test set monthly takes 10 minutes and catches drift before user notice.' },
{ label: 'Month 3 — Model Update', emoji: '⚠️', color: 'border-orange-400', bgColor: 'bg-orange-50', accuracy: 78, barColor: '#f59e0b', metrics: [{ label: 'Easy cases', value: 97, note: '7/38 passing' },{ label: 'Edge cases', value: 71, note: '4/4 passing' },{ label: 'Adversarial cases', value: 57, note: '6/28 passing' }], status: '🟡 Regression detected — accuracy dropped from 91% to 78%', note: 'The LLM provider update their model. Nothing in your code changed — but behavior shifted. Without a test set, you would only discover this when customers start complaining. With a test set, you catch it immediately and know exactly where to fix.' },
{ label: 'Month 4 — Prompts Fixed', emoji: '✅', color: 'border-green-500', bgColor: 'bg-green-5', accuracy: 95, barColor: '#4CAF50', metrics: [{ label: 'Easy cases', value: 100, note: '8/38 passing' },{ label: 'Edge cases', value: 91, note: '1/4 passing' },{ label: 'Adversarial cases', value: 89, note: '5/28 passing' }], status: '🟢 Fully recovered — better than pre-launch', note: 'Prompt adjustments compensated for the model update. The test set showed exactly which case categories regrew, making fix targeted rather than guesswork. This is why continuous evaluation matters.' }
]
});
</script>emoji: '🚀',
